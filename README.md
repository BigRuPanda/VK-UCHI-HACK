...
- [Как установить исходный проект](#как-установить-исходный-проект)
...
Мы выбрали тему магии, потому что она хорошо подходит как для мальчиков, так и для девочек. Мы изучили визуальный стиль Uchi.ru и постарались выполнить игру в этом стиле.
...
Модуль для оффлайн трекинга рук через MediaPipe Hands WASM и вебкамеру. В игре используется для ловли игровых снарядов "руками" с экрана. Снаряды летят с эффектом "на тебя". Чтобы левая и правая руки на экране не путались, мы сделали умную сортировку рук по X-координате.
...
## Как установить исходный проект
> Требуется git. Рекомендуется Unity editor version 6000.4.4f1
...
git clone https://github.com/BigRuPanda/VK-UCHI-HACK.git
```
Добавить папку с проектом в Unity Hub

## Как запустить
> Перед запуском требуется собрать Build проекта и установить python3
